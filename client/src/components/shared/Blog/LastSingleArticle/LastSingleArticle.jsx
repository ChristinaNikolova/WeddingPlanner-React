    ...
    return (
        <div className={styles["last-three-articles-current-article-wrapper"]}>
            <img
                ...
                src={image}
                alt={title} />
            <h5 className={styles["last-three-articles-current-article-title"]}>{title}</h5>
            <p className={styles["last-three-articles-current-article-short-content"]}>{shortContent}</p>
